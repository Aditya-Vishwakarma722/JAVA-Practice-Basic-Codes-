...
- **Collections Framework**  
  Lists, Sets, Maps, and common operations on them.

- **Multithreading & Concurrency**  
  Threads, Runnable, synchronization, and basic concurrent patterns.

- **Exception Handling**  
  Try-catch blocks, custom exceptions, checked vs unchecked exceptions.

- **Other Core Concepts**  
  Generics, Java I/O, enums, static & final keywords, and JVM basics.
...
- This folder is intended for **learning, practice, and reference**, not production use.    
...
- To improve **code organization, readability, and professional habits**.
